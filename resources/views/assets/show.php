...
<main class="card">
    ...
    <section class="details">
        <div class="detail">
            <label>Category</label><span><?= htmlspecialchars($asset['category_name'] ?? 'N/A') ?></span></div>
        ...
        <div class="detail"><label>Serial
                Number</label><span><?= htmlspecialchars($asset['serial_number'] ?? 'N/A') ?></span></div>
        <div class="detail"><label>Purchase
                Date</label><span><?= htmlspecialchars($asset['purchase_date'] ?? 'N/A') ?></span></div>
        <div class="detail"><label>Warranty
                Date</label><span><?= htmlspecialchars($asset['warranty_date'] ?? 'N/A') ?></span></div>
        <div class="detail"><label>Vendor</label><span><?= htmlspecialchars($asset['vendor_name'] ?? 'N/A') ?></span>
        </div>
