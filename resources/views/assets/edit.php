...
<div class="edit-container<?php echo (!empty($_SESSION['user_role']) && $_SESSION['user_role'] === 'ADMIN') ? ' admin-edit' : ''; ?>">
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h1>Edit Asset</h1>
            <p>Modify details for <?php echo htmlspecialchars($old['name'] ?? $assetData['name'] ?? 'User'); ?></p>
        </div>
        <!-- ========================= -->
        ...
        <form action="index.php?route=assets/edit&id=<?= (int)($_GET['id'] ?? 0) ?>" method="post">
            <div class="form-grid">
                ...
                <div class="form-group full-width <?php echo isset($errors['profile_image']) ? 'has-error' : ''; ?>">
                    ...
                    <?php if (!empty($assetData['profile_image'])): ?>
                        <div class="error-text" style="margin-top: 10px; display: block; color: #475569;">
                            Current image:
                            <strong><?php echo htmlspecialchars($assetData['profile_image']); ?></strong>
                        </div>
                    <?php endif; ?>
                ...
                <div class="actions-row">
                    <a href="index.php?route=assets/show&id=<?= $_GET['id']; ?>" class="btn-cancel">Cancel</a>
